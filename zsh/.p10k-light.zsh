# Based on Powerlevel10k lean config generated on 2026-06-22.
# romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 2674.
...
# Light variant — optimized for light terminal backgrounds (Solarized Light).
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%242F'  # dark grey foreground
      local      clean='%28F'   # green foreground
      local   modified='%130F'  # dark yellow/orange foreground
      local  untracked='%33F'   # blue foreground
      local conflicted='%160F'  # red foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%246F'  # medium grey foreground
      local      clean='%246F'  # medium grey foreground
      local   modified='%246F'  # medium grey foreground
      local  untracked='%246F'  # medium grey foreground
      local conflicted='%246F'  # medium grey foreground
    fi
